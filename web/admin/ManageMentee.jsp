...
<html>
        ...
        <div class="d-flex">
            ...
            <div class="container-fluid">
                ...
                <div class="skills-container">
                    <div class="mb-3">
                        <h5 style="font-weight: bold">Manage Mentee</h5>
                    </div>
                    ...
                    <div style="height: 300px">
                        ...
                        <tbody>
                            <c:forEach items="${requestScope.mentees}" var="a" varStatus="status">
                                <tr>
                                    ...
                                    <td>${a.phoneNumber}</td>
                                    <td>${a.address}</td>
                                    <td><button onclick="gotoProfile('${a.userID}')"><i class="fa-solid fa-circle-info"></i></button></td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    </table>
                    ...
                    <div class="paged-list">
                        <c:forEach var="i" begin="1" end="${end_page}">
                            <a href="manageMentee?page=${i}" class="${i == current_page ? 'active' : ''}">
                                ${i}
                            </a>
                        </c:forEach>
                    </div>
    ...
    <script>
                                        ...
                                        function gotoProfile(id) {
                                            window.location.href = '/OnlineRentTutor/Manage/MenteeDetail?' + 'id=' + id;
                                        }
