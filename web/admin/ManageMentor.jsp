...
<html>
        ...
        <div class="d-flex">
            ...
            <div class="container-fluid">
                ...
                <div class="skills-container">
                    <div class="mb-3">
                        <h5 style="font-weight: bold">Manage Mentor</h5>
                    </div>
                    ...
                    <div style="height: 300px">
                        <table class="skills-table">
                            ...
                            <tbody>
                                <c:forEach items="${requestScope.mentors}" var="a" varStatus="status">
                                    <tr>
                                        ...
                                        <td>${a.address}</td>
                                        <td>
                                            <button onclick="gotoProfile('${a.userID}')">
                    ...
                    <div class="paged-list">
                        <c:forEach var="i" begin="1" end="${end_page}">
                            <a href="manageMentor?page=${i}" class="${i == current_page ? 'active' : ''}">
                                ${i}
                            </a>
                        </c:forEach>
                    </div>
    ...
    <script>
                                                ...
                                                function gotoProfile(id) {
                                                    window.location.href = '/OnlineRentTutor/Manage/MentorDetail?' + 'id=' + id;
                                                }
