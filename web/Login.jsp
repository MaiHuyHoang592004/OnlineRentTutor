                                    ...
                                    <form action="login" method="post">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="input-group input-group-lg">
                                                ...
                                                <input name="username" type="text" class="form-control border-0 bg-light rounded-end ps-1"
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="input-group input-group-lg">
                                                ...
                                                <input name="password" type="password" class="form-control border-0 bg-light rounded-end ps-1"
                                        ...
                                        <div class="mb-4 d-flex justify-content-between mb-4">
                                            ...
                                            <div class="text-primary-hover">
                                                <a href="ForgotPassword.jsp" class="text-secondary">
                                                    <u>Forgot password?</u>
                                                </a>
                                            </div>
                                        </div>
