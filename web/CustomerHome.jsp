                ...
                <div class="container">
                    ...
                    <div class="row align-items-center g-5">
                        ...
                        <div class="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
                            ...
                            <!-- Title -->
                            <h1 class="mb-0 display-6">Master English-        
                                <span class="position-relative">Reach Your Dreams!
                                    <!-- SVG START -->
                            ...
                            <!-- Content -->
                            <p class="my-4 lead">Welcome to OnlineRentTutor - your top choice for online English tutoring! Our expert tutors help primary, secondary, and high school students, plus IELTS and TOEIC learners, excel with flexible, effective lessons anytime, anywhere.
                ...
                <div class="container">
                    ...
                    <ul class="nav nav-pills nav-pills-bg-soft justify-content-sm-center mb-4 px-3" id="course-pills-tab" role="tablist">
                        ...
                        <li class="nav-item me-2 me-sm-5">
                            <a href="./SkillDetail" class="nav-link mb-2 mb-md-0 active" role="tab">
                                View All English Skill Here
                            </a>
                        </li>                        
                    </ul>
            ...
            <section class="pt-0 pt-lg-5">
                <div class="container position-relative">
                                ...
                                <div class="row position-relative">
                                    ...
                                    <div class="col-11 mx-auto position-relative">
                                        <div class="row align-items-center">
                                            <!-- Title -->
                                            <div class="col-lg-7">
                                                <h3 class="text-white">Become a Mentor!</h3>
                                            ...
                                            <div class="col-lg-5 text-lg-end">
                                                <a href="BecomeMentor.jsp" class="btn btn-outline-warning mb-0">Start Teaching Today</a>
                                            </div>
                                        </div>
                                    </div>
                                </div> <!-- Row END -->
                    ...
                    <div class="mentor-text">
                        <h2>View All Mentors</h2>
                        <p>Browse through a list of qualified mentors who are ready to share their knowledge. Whether you're looking for a mentor to guide you through your career or personal growth, our mentors are here to help you succeed.</p>
                    </div>

                    <!-- Button to redirect to view all mentors -->
                    <a href="./ViewMentor" class="mentor-button">View All Mentors</a>
                </div>
