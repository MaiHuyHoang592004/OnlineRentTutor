            ...
            <nav class="navbar navbar-expand-xl">
                <div class="container-fluid px-3 px-xl-5">
                    ...
                    <div class="navbar-collapse w-100 collapse" id="navbarCollapse">
						...
						<a class="nav-link active" href="#" id="demoMenu" aria-haspopup="true" aria-expanded="false">Homes</a>						
					</li>

                            <!-- Become tutor   -->
                            <li class="nav-item dropdown dropdown-fullwidth">
                                <li class="nav-item">
                                    <a class="nav-link" aria-current="page" href="Login.jsp">Become a Mentor</a>
                                </li>                              
                            </li>
                        <!-- Nav Main menu END -->
                    </div>
                    <form action="login" method="get">
                        <div class="navbar-nav ms-2">
                            <button type="submit" class="btn btn-sm btn-dark mb-0" href="Login.jsp"><i class="bi bi-power me-2"></i>Sign In</button>
                        </div>
                    </form>
...
<ul class="nav nav-pills nav-pills-bg-soft justify-content-sm-center mb-4 px-3" id="course-pills-tab" role="tablist">
                        ...
                        <li class="nav-item me-2 me-sm-5">
                            <a href="Login.jsp" class="nav-link mb-2 mb-md-0 active" role="tab">
            ...
            <section class="pt-0 pt-lg-5">
                ...
                <div class="mentor-section">
                    ...
                    <a href="#" class="mentor-button">View All Mentors</a>
                </div>
